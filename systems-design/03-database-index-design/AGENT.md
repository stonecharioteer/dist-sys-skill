...
Expect table/query assumptions, index proposals, and trade-off discussion; testing should focus on query behavior, not vendor syntax.
...
- provide canonical query shapes and expected access patterns
