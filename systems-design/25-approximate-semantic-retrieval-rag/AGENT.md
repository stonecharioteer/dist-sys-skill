# Agent notes for 25. Approximate semantic retrieval / RAG retrieval platform
...
Expect corpus/update assumptions, retrieval pipeline stages, and quality-vs-latency trade-offs.
...
- model document ingest, re-embed, and delete flows
- test freshness lag and stale-result windows
- evaluate query fanout and latency budgets
- define offline and online quality signals for retrieval
