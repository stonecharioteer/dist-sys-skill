# Agent notes for 21. Scaling consumer groups for ordered event processing
...
Expect numeric reasoning plus ordering guarantees, not just “add more consumers”.
...
- feed partition counts and traffic skew
- check throughput and lag calculations
- inject consumer loss and rebalance events
- verify ordering constraints are preserved
