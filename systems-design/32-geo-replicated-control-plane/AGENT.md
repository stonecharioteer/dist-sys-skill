# Agent notes for 32. Geo-replicated control plane
...
Expect region topology, failover semantics, operator workflow, and cost/latency trade-offs.
...
- simulate full region outage and partial inter-region partition
- test stale-configuration exposure windows
- check control-plane vs data-plane dependency isolation
- verify recovery/runbook and observability expectations
