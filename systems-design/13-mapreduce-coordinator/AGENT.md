# Agent notes for 13. MapReduce coordinator
...
Expect concise coordination logic, worker protocol, and bottleneck analysis for the coordinator.
...
- simulate worker heartbeats, timeouts, and duplicate completions
- verify phase barrier logic
- test skewed task durations
- check whether coordinator state can recover after restart if claimed
