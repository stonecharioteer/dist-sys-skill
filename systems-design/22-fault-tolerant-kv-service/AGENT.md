# Agent notes for 22. Fault-tolerant key-value service
...
Expect replication semantics, recovery paths, and a clear consistency target.
...
- inject leader crash before and after quorum/ack events
- replay reads/writes through failover
- test replica catch-up and stale read boundaries
- score whether invariants are stated precisely
