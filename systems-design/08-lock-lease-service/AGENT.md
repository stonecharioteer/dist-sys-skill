# Agent notes for 08. Lock / lease service
...
Expect clear invariants, ownership tokens, and edge-case handling under client retries and timeouts.
...
- simulate contended acquire/release flows
- test stale release and expired lease renewals
- inject client retry duplication
- verify that lease expiry rules are documented and testable
