...
Expect exact cache semantics, complexity reasoning, and observability basics; do not require distributed cache coherence yet.
...
- feed deterministic access sequences and verify eviction order
- test mixed reads/writes with TTL expiry
- measure hit/miss accounting correctness
- surface pathological scans that thrash the cache
