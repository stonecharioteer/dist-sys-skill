# Agent notes for 27. Conversation memory service
...
Expect storage model, context assembly path, retention/privacy policy, and failure handling for stale or poor summaries.
...
- simulate long conversations that exceed context limits
- test summary refresh and stale-summary correction paths
- verify deletion/privacy semantics
- evaluate latency of context assembly under hot sessions
