# Agent notes for 07. Linearizable key-value store with compare-and-set
...
Expect invariants, version or lock strategy, and how the solver would argue correctness.
...
- replay concurrent Get/Put/CAS histories
- check accepted histories against the declared linearization model
- stress retries and duplicate client requests
- verify crash behavior does not violate acknowledged ordering
