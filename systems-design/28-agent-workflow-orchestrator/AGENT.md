# Agent notes for 28. Agent workflow orchestrator
...
Expect durable workflow state, execution model, failure handling, and observability for branching plans.
...
- simulate branching workflows, tool failures, and retry storms
- inject orchestrator restart mid-execution
- verify loop-detection or guardrail strategy
- check traceability of each step and external side effect
