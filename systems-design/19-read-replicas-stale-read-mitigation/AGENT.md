# Agent notes for 19. Read replicas and stale-read mitigation
...
Expect consistency guarantees, lag observability, and user-facing mitigation strategies.
...
- inject replica lag and leader failover
- check read-your-writes expectations against routing policy
- model promotion of a lagging replica
- verify staleness metrics and alerts
