# Agent notes for 17. Partition-key selection for a multi-tenant event platform
...
Expect a comparison matrix and explicit reasoning about ordering scope and hot tenants.
...
- provide mixed-tenant traffic distributions
- check whether proposed keys preserve required ordering
- simulate hot-tenant skew and rebalance events
- score blast-radius reasoning
