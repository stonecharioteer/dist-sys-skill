# Agent notes for 31. Reconfigurable sharded key-value service
...
Expect migration protocol, ownership invariants, failure handling, and operational visibility during moves.
...
- inject controller failure mid-migration
- replay reads/writes during shard handoff
- check epoch monotonicity and ownership invariants
- verify metrics for lagging or stuck migrations
