# Agent notes for 23. Sharded rate limiter
...
Expect partition strategy, consistency choice for counters, and overload behavior.
...
- generate hot-key and even-key traffic mixes
- test fail-open vs fail-closed policies
- simulate shard loss or counter lag
- check fairness under multi-tenant contention
