# Agent notes for 20. Idempotent webhook ingestion and processing pipeline
...
Expect a durable ingest path, consumer model, failure analysis, and observability plan.
...
- simulate duplicate and out-of-order deliveries
- inject downstream failure after durable persistence
- verify replay tooling requirements
- check latency, lag, and duplicate-rate metrics
