# Agent notes for 30. Social graph edge store under skew
...
Expect graph-specific access patterns, skew reasoning, and a realistic view of cache/storage interaction.
...
- feed point lookups, edge scans, and celebrity-node workloads
- measure partition imbalance under power-law data
- test pagination stability for long adjacency lists
- verify p99 handling under hot-node bursts
